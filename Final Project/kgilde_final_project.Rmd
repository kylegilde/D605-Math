...
packages <- c("prettydoc",'dplyr', 'psych', 'knitr', 'ggplot2', 'MASS', 'MLmetrics') 
...
NA_ct = rapply(train_df, function(x) sum(is.na(x)))
df_summary <- data.frame(
  NA_ct = NA_ct,
  NA_percent = NA_ct / df_len,
...
df_summary <- cbind(df_summary, metrics)
